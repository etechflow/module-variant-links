 ...
 * (only the rendered HTML is cleaned), so the change is fully reversible.
 *
 * Gated by the licence (the module is inert when unlicensed) AND by the
 * `buttons/strip_legacy` config flag.
 */
